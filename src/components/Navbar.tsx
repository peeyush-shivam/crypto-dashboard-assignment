  ...
  return (
    <nav className="navbar w-full h-16 flex justify-between items-center shadow-md pl-24 pr-24 gap-4 max-md:pl-8 max-md:pr-8 fixed top-0 z-10 bg-white">
      ...
      <div className="flex flex-col justify-center items-center">
        <span className="text-[#cb9140] text-3xl font-semibold">CoinMark</span>
        <span className="text-slate-400 text-xs font-semibold max-sm:hidden ">
          Know your crypto, way before the world does.
        </span>
      </div>
